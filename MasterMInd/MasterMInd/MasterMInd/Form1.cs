...
namespace MasterMInd
{
    ...
    public partial class Form1 : Form
    {
        ...
        public string AIRand(int [] checkAnswerParam)
        {
            int rand = rng.Next(5);
            string chosencolor = "";
            switch (rand)
            {
                case 0:
                    if (checkAnswerParam[1] == 1)
                    {
                        chosencolor = "Red";
                    }
                    break;
                case 1:
                    if (checkAnswerParam[2] == 1)
                    {
                        chosencolor = "Green";
                    }
                    break;
                case 2:
                    if (checkAnswerParam[3] == 1)
                    {
                        chosencolor = "Blue";
                    }
                    break;
                case 3:
                    if (checkAnswerParam[4] == 1)
                    {
                        chosencolor = "Yellow";
                    }
                    break;
                case 4:
                    if (checkAnswerParam[5] == 1)
                    {
                        chosencolor = "Black";
                    }
                    break;
                case 5:
                    if (checkAnswerParam[6] == 1)
                    {
                        chosencolor = "White";
                    }
                    break;
        ...
        public void AIRand()
        {
          ...
          private void AI()
          {
              ...
              int r = 0;
              int c = 0;
              int[] checkAnswersParams = new int[6] {1,1,1,1,1,1};
              ...
              while (r != 12)
              {
                  ...
                  for (int i = 0; i < 4; i++)
                  {
                      ...
                      if (answersInfo[i] == 0)
                      {
                          string color = guess[i];
                          if (color == "Red")
                          {
                              checkAnswersParams[0] = 0;
                          }
                          if (color == "Green")
                          {
                              checkAnswersParams[1] = 0;
                          }
                          if (color == "Blue")
                          {
                              checkAnswersParams[2] = 0;
                          }
                          if (color == "Yellow")
                          {
                              checkAnswersParams[3] = 0;
                          }
                          if (color == "Black")
                          {
                              checkAnswersParams[4] = 0;
                          }
                          if (color == "White")
                          {
                              checkAnswersParams[5] = 0;
                          }
                      }
                  }
              }
